<div class="col-md-2">
    <img class="rounded-circle" src="{{ !empty($user->profile_photo_path) ? '/frontend/profile-photos/'.$user->profile_photo_path : '/frontend/profile-photos/avatar.jpg' }}" alt="User Avatar" height="100%" width="100%">
