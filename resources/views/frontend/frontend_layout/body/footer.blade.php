        ...
        <div class="row">
            ...
            <div class="module-body">
                ...
                <li class="media">
                    ...
                    <p>Ikeja, Lagos Nigeria.<br/> West Africa.</p>
                    </div>
                </li>
                <li class="media">
                ...
                <li class="media">
                    ...
                    <div class="media-body"> <span><a href="mailto:support@scooterlux.com">support@scooterlux.com</a></span> </div>
                </li>
                </ul>
            </div>
            <!-- /.module-body --> 
            ...
            <div class="module-body">
                ...
                <li><a href="{{route('user.orders')}}" title="Order History">Order History</a></li>
